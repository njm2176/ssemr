...
(
    ...
    hiv_status_during_mapping                         VARCHAR(255),
    results_at_mapping                                VARCHAR(255),
    results_of_hts                                    VARCHAR(255),
    date_hiv_tested                                   DATE,
    ...
    family_member_phone_number                        VARCHAR(255),
